...
import com.fad.view.producto.weaProducto;
 ...
 * @author edist
 */
public class weaProducto extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(weaProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new weaProducto().setVisible(true);
            }
        });
    }
